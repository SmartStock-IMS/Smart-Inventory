...
const RepDetails = () => {
    ...
    if (result.success && result.data) {
      ...
      const salesRepsData = result.data.data.users.map((user) => ({
        ...
        users: {
          ...
          phone: user.phone,
          contact: user.phone,
          address: "No Address Available" // Add from API if available
        }
      }));
      ...
      if (foundRep) {
        ...
        navigate("/administrator/sales-rep");
      }
    } else {
  ...
  if (isLoading) {
    return (
      <div className="h-full w-full bg-gradient-to-br from-blue-50 via-white to-emerald-50 rounded-3xl border border-gray-200 shadow-xl flex items-center justify-center">
        <div className="text-center">
          <div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse">
    ...
    return (
      <div className="h-full w-full bg-gradient-to-br from-red-50 via-white to-red-50 rounded-3xl border border-red-200 shadow-xl flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <button
            onClick={() => navigate("/administrator/sales-rep")}
  ...
  return (
    <div className="h-full w-full bg-gradient-to-br from-blue-50 via-white to-emerald-50 rounded-3xl border border-gray-200 shadow-xl overflow-hidden">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-blue-500 to-blue-400 text-white p-6 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={() => navigate(`/administrator/sales-rep/edit/${repCode}`)}
