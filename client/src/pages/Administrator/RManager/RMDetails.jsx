...
//import OrderDetails from "@components/administrator/orders/OrderDetails";
    ...
    const fetchRMDetails = async () => {
      try {
        ...
        if (result.success && result.data) {
          ...
          navigate("/administrator/rm-list");
        }
      } catch (error) {
    ...
    return (
      <div className="h-full w-full bg-gradient-to-br from-red-50 via-white to-red-50 rounded-3xl border border-red-200 shadow-xl flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <button
            onClick={() => navigate("/administrator/rm-list")}
              ...
              <div className="lg:col-span-1">
                <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                  ...
                  {/* {isEditing ? (
                    ...
                    <button
                      onClick={() => navigate(`/administrator/rm-edit/${rep.resource_manager_id}`)}
