    ...
    try {
      ...
      if (validateForm()) {
        ...
        if (result.success) {
          ...
          setTimeout(() => {
            setIsLoading(false);
            navigate.push('/inventorymanager/rm-list');
          }, 3000);
        } else {
    ...
    <div className="h-full bg-gradient-to-br from-gray-50 via-white to-gray-50 rounded-3xl border border-gray-200 shadow-xl overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 text-white p-6 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold mb-1">Add Resource Manager</h2>
            <p className="text-white/80">Create a new resource manager profile</p>
          </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="text-gray-600 text-sm mb-3">Add a professional photo for the resource manager</p>
