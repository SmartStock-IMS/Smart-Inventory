...
const createResourceManager = async (rmdata) => {
  try {
    ...
    console.log("Resource manager data being sent:", rmdata);

    // Don't use FormData for this API - send as JSON
    const response = await axios.post(API_URL, rmdata, {
      headers: {
    ...
    return {
      success: false,
      message:
        error.response?.data?.message || "Failed to create resource manager",
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        console.log("Mapped API data:", rmdata);

        const result = await createResourceManager(rmdata);
        ...
        if (result.success) {
          ...
          setTimeout(() => {
            navigate.push("/inventorymanager/RManager");
          }, 2000);
        } else {
          console.log("API validation errors:", result.errors);
          toast.error(result.message || "Failed to create Resource manager");
        ...
        toast.error("An error occurred while creating the resource manager");
      } finally {
        setIsLoading(false);
      }
    },
            ...
            <div className="relative flex items-center justify-center gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-indigo-100 mt-2">
                  Create a new resource manager account
                </p>
              </div>
            </div>
            {/* Decorative elements */}
              ...
              <div className="mb-6 p-4 bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-400 rounded-lg shadow-md">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-green-700 font-medium">
                    Resource Manager successfully added! 🎉
                  </p>
                </div>
              </div>
            )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder="resourceManager@example.com"
                      required
                    />
                  </div>
                  <div className="space-y-2">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows="3"
                    className="w-full rounded-xl border-2 border-gray-200 px-4 py-3 text-sm focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500/20 transition-all duration-200 hover:border-gray-300 resize-none"
                    placeholder="Enter assigned resource management region"
                  />
                </div>
                ...
                >
                  {isLoading ? (
                    <div className="flex items-center gap-2">
                      ...
                      <span>Adding Resource Manager...</span>
                    </div>
                  ) : (
                    <div className="flex items-center gap-2">
