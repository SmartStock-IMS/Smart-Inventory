...
const ProductList = () => {
  ...
  return (
    <div className="h-full w-full p-2 bg-white rounded-md">
      <div className="h-auto lg:h-[10%] pb-2 px-3 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 border-b border-gray-500">
        <div className="w-full sm:w-1/3 flex flex-row items-center gap-2">
          <List className="h-6 w-6" />
          <h2 className="text-lg font-bold">Product List</h2>
        </div>
        <div className="w-full sm:w-1/3 px-3 flex flex-row items-center gap-1 text-sm bg-gray-200 rounded-md">
      ...
      <div className="flex-1 lg:h-[90%] overflow-y-auto">
        {products.length > 0 ? (
            ...
            <table className="w-full table-auto border-collapse text-sm min-w-[640px]">
              <thead className="hidden sm:table-header-group">
                <tr className="border-b border-gray-200">
                  ...
                  <th className="px-4 py-2 text-center text-gray-600 font-medium">Category</th>
                  <th className="px-4 py-2 text-center text-gray-600 font-medium">Variants</th>
                ...
                >
                  <td className="px-4 py-2">
                    <img
                      ...
                      alt={product.name}
                      className="w-12 h-12 sm:w-16 sm:h-16 p-1 object-contain rounded-lg border"
                    />
                  </td>
                  <td className="px-4 py-2">
                    <Link
                  ...
                  <td className="px-4 py-2 text-center">
                    <div className="flex flex-col sm:flex-row items-center gap-2">
                      ...
                      <Link
                        to={`/dashboard/product/${product.id}`}
                        state={product}
                        className="px-3 py-1.5 flex flex-row items-center justify-center gap-2 bg-blue-500 text-white rounded-md text-sm font-medium hover:bg-blue-600"
                      >
