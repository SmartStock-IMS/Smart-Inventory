  ...
  const menuItems = [
    {
      ...
      isActive: location.pathname === "/inventorymanager"
    },
    {
      id: "orders",
      label: "Orders",
    ...
    },
    {
      ...
      hasSubmenu: true,
      submenu: [
        { label: "Add Customer", path: "/inventorymanager/addcustomer" },
        { label: "Customer List", path: "/inventorymanager/customer-list" }
      ]
    },
    {
      id: "salesreps",
