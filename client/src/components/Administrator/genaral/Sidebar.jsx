...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      hasSubmenu: true,
      submenu: [
        { label: "Customer List", path: "/administrator/customer-list" },
      ],
    },
    {
      id: "salesreps",
      ...
      hasSubmenu: true,
      submenu: [{ label: "Sales-Rep List", path: "/administrator/sales-rep" }],
    },

    {
      ...
      lucideIcon: Settings,
      hasSubmenu: true,
      submenu: [{ label: "RM List", path: "/administrator/rm-list" }],
    },
    {
      id: "reports",
      label: "Reports",
  ...
  return (
    <div className="h-full flex flex-col relative">
      ...
      {/* Sidebar Content */}
      <div
        className={`h-full flex flex-col text-white shadow-2xl relative overflow-hidden transition-all duration-300 ${
          isDarkMode
      ...
      >
              ...
              {item.hasSubmenu ? (
                <div>
                  ...
                  {!isCollapsed && (
                    ...
                    >
                      <div
                        className={`ml-6 mt-2 space-y-1 border-l-2 pl-4 ${
        ...
        {/* Footer Actions */}
        <div
          className={`relative z-10 p-4 border-t space-y-2 transition-colors duration-300 ${
        ...
        {/* Decorative Elements */}
        <div
          className={`absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t pointer-events-none transition-colors duration-300 ${
            isDarkMode ? "from-slate-900/50" : "from-gray-100/50"
          } to-transparent`}
        ></div>
        <div
          className={`absolute top-20 right-0 w-32 h-32 bg-gradient-to-l rounded-full blur-3xl pointer-events-none transition-colors duration-300 ${
            isDarkMode ? "from-blue-500/10" : "from-blue-200/20"
          } to-transparent`}
        ></div>
        <div
          className={`absolute bottom-20 left-0 w-24 h-24 bg-gradient-to-r rounded-full blur-2xl pointer-events-none transition-colors duration-300 ${
